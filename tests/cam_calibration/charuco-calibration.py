...
PATH = 'C:\\rehab\\taiko-joy-src\\tests\\cam_calibration\\captures_left'  #folder with the captures
MASK = 'cam_*.png'

# IMPORTANT RUN THIS SCRIPT TWO TIMES ONE FOR EACH CAMERA, TAKES LESS TIME THAN MODIFY THIS PROGRAM
# IMPORTANT RUN THIS SCRIPT TWO TIMES ONE FOR EACH CAMERA, TAKES LESS TIME THAN MODIFY THIS PROGRAM
# IMPORTANT RUN THIS SCRIPT TWO TIMES ONE FOR EACH CAMERA, TAKES LESS TIME THAN MODIFY THIS PROGRAM
# IMPORTANT RUN THIS SCRIPT TWO TIMES ONE FOR EACH CAMERA, TAKES LESS TIME THAN MODIFY THIS PROGRAM
...
images = glob.glob(os.path.join(PATH , MASK))
